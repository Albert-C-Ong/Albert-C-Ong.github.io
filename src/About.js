      ...
      <div class="modal-body row m-5">
        <div class="col-md-6">
          <div class="">
            ...
            <div class="fs-5" style={{hover: "red"}}>
              ...
              <p class="mt-5">For inquiries, contact <a class="cornflowerblue" href="mailto:albert_ong_us@yahoo.com">albert_ong_us@yahoo.com</a></p>
            </div>
          </div>
        </div>
